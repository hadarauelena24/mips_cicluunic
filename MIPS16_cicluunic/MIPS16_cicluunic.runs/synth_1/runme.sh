...
HD_PWD='C:/Users/elena/OneDrive/Desktop/facultate/an2/AC/MIPS16_cicluunic/MIPS16_cicluunic.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MIPS16_unic.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MIPS16_unic.tcl
